...
def get_tool_index():
    """Get the complete tool index, using protect server's registration mode and manifest."""
    try:
    ...
    checker = PermissionChecker(category_map=PROTECT_CATEGORY_MAP, permissions=config.permissions)
