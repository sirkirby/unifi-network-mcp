"""Tool index and registry system for the UniFi Protect MCP server.
...
decorator in main.py, and can be queried via the protect_tool_index tool.
...
class ToolMetadata:
    ...
    Attributes:
        name: Tool name (e.g., "protect_list_cameras")
...
async def tool_index_handler(args: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    Returns machine-readable list of available UniFi Protect MCP tools with their schemas
