"""Network server category mappings, tool module map, and permission helpers.
...
def parse_permission(permissions: Dict[str, Any], category: str, action: str) -> bool:
    ...
    """
    checker = PermissionChecker(category_map=NETWORK_CATEGORY_MAP, permissions=permissions)
