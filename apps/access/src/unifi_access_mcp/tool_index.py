"""Tool index and registry system for the UniFi Access MCP server.
...
decorator in main.py, and can be queried via the access_tool_index tool.
...
class ToolMetadata:
    ...
    Attributes:
        name: Tool name (e.g., "access_list_doors")
...
async def tool_index_handler(args: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    Returns machine-readable list of available UniFi Access MCP tools with their schemas
