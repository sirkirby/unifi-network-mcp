"""Validator registry for UniFi Access resources.

Validators will be registered as Access tools are implemented.
"""
...
class AccessValidatorRegistry:
    """Registry for UniFi Access resource validators."""
